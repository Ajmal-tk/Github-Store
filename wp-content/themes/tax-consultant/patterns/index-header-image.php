 ...
 * Slug: tax-consultant/index-header-image
 * Categories: tax-consultant, index-header-image
 */
?>
...
<h2 class="wp-block-heading has-text-align-center" style="text-transform:uppercase"><?php echo esc_html__('blog','tax-consultant'); ?></h2>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->