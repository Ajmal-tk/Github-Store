 ...
 * Slug: tax-consultant/single-product
 * Categories: tax-consultant, single-product
 */
?>
...
<h2 class="wp-block-heading has-text-align-left has-large-font-size" style="margin-top:1rem;margin-bottom:1rem"><?php esc_html_e('Related Products','tax-consultant'); ?></h2>
<!-- /wp:heading -->
